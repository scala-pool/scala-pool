			...
			minerStat.hashes = {
				...
				solo : 0
                    ...
                    currentRoundMiners.push({
                        ...
                        roundShares:{props:Number(((minerStat.hashes.props) || 0 / data.current.hashes.props) * 100).toFixed(5),solo:Number((minerStat.hashes.solo || 0)/data.current.hashes.solo ).toFixed(5)},
